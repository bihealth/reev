  ...
  <v-layout class="rounded rounded-md">
    ...
    <v-main style="min-height: 300px">
      <div v-if="geneInfoStore.storeState == StoreState.Active" class="gene-info">
        <v-row>
          <v-col cols="12" md="4">
            <v-card title="HGNC" variant="tonal">
              <v-divider></v-divider>
              <v-card-item>
                <div>
          ...
          <v-col cols="12" md="4">
            <v-card title="Constraints/Scores" variant="outlined">
              <v-card-title>gnomAD</v-card-title>
              <v-divider></v-divider>
              <v-card-item>
                <v-table style="width: 100%">
                  ...
                  <tbody>
                    <tr>
                      <td>Synonymous</td>
                      <td
                        v-html="roundIt(geneInfoStore.geneInfo?.gnomad_constraints?.exp_syn, 1)"
                      ></td>
                      <td
                        v-html="roundIt(geneInfoStore.geneInfo?.gnomad_constraints?.obs_syn, 1)"
                      ></td>
                      <td>
                        Z =
                        <span
                        ...
                        o/e =
                        <span
                          v-html="roundIt(geneInfoStore.geneInfo?.gnomad_constraints?.oe_syn)"
                        />
                        (<span
                    ...
                    <tr>
                      <td>Missense</td>
                      <td
                        v-html="roundIt(geneInfoStore.geneInfo?.gnomad_constraints?.exp_mis, 1)"
                      ></td>
                      <td
                        v-html="roundIt(geneInfoStore.geneInfo?.gnomad_constraints?.obs_mis, 1)"
                      ></td>
                      <td>
                        Z =
                        <span
                        ...
                        o/e =
                        <span
                          v-html="roundIt(geneInfoStore.geneInfo?.gnomad_constraints?.oe_mis)"
                        />
                        (<span
                    ...
                    <tr>
                      <td>pLoF</td>
                      <td
                        v-html="roundIt(geneInfoStore.geneInfo?.gnomad_constraints?.exp_lof, 1)"
                      ></td>
                      <td
                        v-html="roundIt(geneInfoStore.geneInfo?.gnomad_constraints?.obs_lof, 1)"
                      ></td>
                      <td>
                        pLI =
                        <span
                          v-html="roundIt(geneInfoStore.geneInfo?.gnomad_constraints?.pli)"
                        /><br />
                        o/e =
                        <span
                          v-html="roundIt(geneInfoStore.geneInfo?.gnomad_constraints?.oe_lof)"
                        />
                        (<span
          ...
          <!-- <v-col cols="12" md="3">
            <v-card title="Locus-Specific Databases" variant="tonal">
              <v-divider></v-divider>
              <v-item>
                <div v-if="geneInfoStore.geneInfo?.hgnc?.lsdb?.length">
                  <div v-for="{ name, url } in geneInfoStore.geneInfo.hgnc.lsdb">
        ...
        <v-row>
          <v-col cols="12" md="12">
            <v-card title="NCBI Summary" variant="tonal">
              <v-divider></v-divider>
              <v-card-item>
        ...
        <v-row>
          <v-col cols="12" md="4">
            <v-card title="Alternative Identifiers" variant="outlined">
              <v-divider></v-divider>
              <v-card-item>
                <div>
                ...
                <div v-if="geneInfoStore.geneInfo?.hgnc?.mgd_id?.length">
                  <strong>MGI: </strong>
                  <template
                    v-for="(mgd_id, index) in geneInfoStore.geneInfo.hgnc.mgd_id"
                    :key="mgd_id"
                  >
                ...
                <div v-if="geneInfoStore.geneInfo?.hgnc?.pubmed_id?.length">
                  ...
                  <template
                    v-for="(pmid, index) in geneInfoStore.geneInfo.hgnc.pubmed_id"
                    :key="pmid"
                  >
                    <template v-if="index > 0">, </template>
          ...
          <v-col cols="12" md="4">
            <v-card title="External Resources" variant="tonal">
              <v-divider></v-divider>
              <v-card-item>
                <v-row>
                  <v-col cols="12" md="6">
          ...
          <v-col cols="12" md="4">
            <v-card title="Disease Annotation" variant="outlined">
              <v-divider></v-divider>
              <v-card-item>
                <div>
        ...
        <v-row>
          <v-col cols="12" md="4">
            <v-card title="ACMG Supplementary Findings List" variant="tonal">
              <v-divider></v-divider>
              <v-card-item>
          ...
          <v-col cols="12" md="8">
            <v-card title="GeneRIFs" variant="outlined">
              <v-divider></v-divider>
              <v-card-item>
                <ul
                  class="overflow-auto"
