        ...
        <v-card>
          ...
          <v-card-text>
            <p class="description">
              ...
              clinicians and researchers in the field of rare disease genetics. This tool empowers
              users by providing comprehensive and aggregated information on genomic variants.
            </p>
            <p class="description">
