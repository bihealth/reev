        ...
        <div class="pathogenic">
          ...
          <ul>
            ...
            <li>
              <h3>PS2 - De novo</h3>
              <p>
                Description: De novo (both maternity and paternity confirmed) in a patient with the
            ...
            <li>
              ...
              <p>
                Description: Well-established in vitro or in vivo functional studies supportive of a
            ...
            <li>
              ...
              <p>
                Description: Patient's phenotype or family history is highly specific for a disease
        ...
        <div class="benign">
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                Description: Missense variant in a gene for which primarily truncating variants are
            ...
            <li>
              ...
              <p>
                Description: A synonymous (silent) variant for which splicing prediction algorithms
                predict no impact to the splice consensus sequence nor the creation of a new splice
