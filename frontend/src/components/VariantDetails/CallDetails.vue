    ...
    >
      ...
      <tbody>
        ...
        <tr>
          ...
          <template v-for="(member, index) in props.caseDescription.pedigree" :key="index">
            <td v-if="props.smallVariant.genotype[member.name].dp === -1" class="text-center">.</td>
        ...
        <tr>
          ...
          <template v-for="(member, index) in props.caseDescription.pedigree" :key="index">
            <td v-if="props.smallVariant.genotype[member.name].ad === -1" class="text-center">.</td>
            <td v-else class="text-center">
        ...
        <tr>
          ...
          <template v-for="(member, index) in props.caseDescription.pedigree" :key="index">
            <td class="text-center">
              {{ allelicBalance(props.smallVariant.genotype[member.name]).toFixed(2) }}
            </td>
          </template>
        </tr>
      </tbody>
