      ...
      <tbody>
        ...
        <tr>
          ...
          <template v-if="varAnnos?.cadd?.PHRED && varAnnos?.cadd?.PHRED !== Infinity">
            ...
            <td class="text-center align-middle">
              <span v-if="varAnnos?.cadd?.PHRED < 0.15" class="benign-strong"> benign strong </span>
              <span
        ...
        <tr>
          ...
          >
            ...
            <td class="text-center align-middle">
              ...
              <span v-else-if="fathmmScore < 4.69 && fathmmScore >= 3.32" class="benign-supporting">
                benign supporting
              </span>
              <span
        ...
        <tr>
          ...
          <template v-if="polyphenScore !== null && polyphenScore !== Infinity">
            ...
            <td class="text-center align-middle">
              <span v-if="polyphenScore <= 0.009" class="benign-moderate"> benign moderate </span>
              <span
        ...
        <tr>
          ...
          >
            ...
            <td class="text-center align-middle">
              <span v-if="props.varAnnos?.dbnsfp?.PrimateAI_score <= 0.362" class="benign-moderate">
                benign moderate
              </span>
              <span
                v-else-if="
        ...
        <tr>
          ...
          <template v-if="siftScore && translatedSiftScore && translatedSiftScore !== Infinity">
            ...
            <td class="text-center align-middle">
              ...
              <span v-else-if="siftScore < 0.327 && siftScore >= 0.08" class="benign-supporting">
                benign supporting
              </span>
              <span v-else-if="siftScore >= 0.001 && siftScore < 0" class="pathogenic-supporting">
                pathogenic supporting
              </span>
        ...
        <tr>
          ...
          <template v-if="revelScore && revelScore !== Infinity">
            ...
            <td class="text-center align-middle">
              ...
              <span v-else-if="revelScore > 0.016 && revelScore <= 0.183" class="benign-moderate">
                benign moderate
              </span>
              <span v-else-if="revelScore > 0.183 && revelScore <= 0.29" class="benign-supporting">
                benign supporting
              </span>
              <span
