...
const acmgRatingSubmitted = computed(() => {
  ...
  return (
    parseInt(acmgRatingToSubmit.value.pvs1) === acmgRatingStore.acmgRating.pvs1 &&
...
watch(
  ...
  async () => {
    if (props.smallVariant && acmgRatingStore.storeState.state === State.Active) {
        ...
        <div class="col px-0">
          ...
          >
            ...
            <label for="acmg-ps4" class="m-0">
              ...
              <span class="text-muted">prevalence in disease &gt; controls</span>
            </label>
          </div>
        </div>
      </div>
        ...
        <div class="col px-0">
          ...
          >
            ...
            <label for="acmg-pm3" class="m-0">
              ...
              <span class="text-muted">AR: <i>trans</i> with known pathogenic</span>
            </label>
          </div>
        </div>
      </div>
...
sequence nor the creation of a new splice site AND the nucleotide is not highly conserved"
    ...
    <div class="col px-0">
      <div class="row pt-4">
        <div class="col px-0"><strong class="text-muted mx-1">5</strong> pathogenic</div>
      </div>
      <div class="row">
        <div class="col px-0"><strong class="text-muted mx-1">4</strong> likely pathogenic</div>
      </div>
      <div class="row">
        <div class="col px-0">
      ...
      <div class="row">
        <div class="col px-0"><strong class="text-muted mx-1">2</strong> likely benign</div>
      </div>
      <div class="row">
        <div class="col px-0"><strong class="text-muted mx-1">1</strong> benign</div>
      </div>
      <div class="row pt-4" title="Automatically determined ACMG class (Richards et al., 2015)">
      ...
      <div class="row" title="Manually override the automatically determined class">
        <div class="col-4 px-0">
      ...
      <div class="row pt-2">
        <div class="col px-0">
          <div class="btn-group ml-auto">
            <button type="button" class="btn btn-sm btn-secondary" @click="unsetAcmgRating()">
              Clear
            </button>
            <button type="button" class="btn btn-sm btn-secondary" @click="resetAcmgRating()">
              Reset
            </button>
            <button
              type="submit"
