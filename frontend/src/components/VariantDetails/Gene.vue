...
<template>
  <div class="row row-cols-3 pr-2 pt-2" style="font-size: 90%">
    ...
    <div class="col mb-2 pl-2 pr-0" v-if="gene?.gnomad_constraints">
      <div class="card h-100">
        <div class="card-header pl-2 pt-1 pb-1 pr-2">
          <span class="font-weight-bolder" style="font-size: 120%"> Constraints / Scores </span>
        </div>
        <div class="card-body pb-2 pt-2">
          <div>
            ...
            <table style="width: 100%" class="constraints-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="pl-2">
                    Z =
                    <span v-html="roundIt(gene?.gnomad_constraints?.syn_z)" /><br />
                    o/e =
                    <span v-html="roundIt(gene?.gnomad_constraints?.oe_syn)" />
                    (<span v-html="roundIt(gene?.gnomad_constraints?.oe_syn_lower)" />
                    -
                    <span v-html="roundIt(gene?.gnomad_constraints?.oe_syn_upper)" />)
                  </td>
                </tr>
                <tr>
                  <td>Missense</td>
                  ...
                  <td class="pl-2">
                    Z =
                    <span v-html="roundIt(gene?.gnomad_constraints?.mis_z)" /><br />
                    o/e =
                    <span v-html="roundIt(gene?.gnomad_constraints?.oe_mis)" />
                    (<span v-html="roundIt(gene?.gnomad_constraints?.oe_mis_lower)" />
                    -
                    <span v-html="roundIt(gene?.gnomad_constraints?.oe_mis_upper)" />)
                  </td>
                </tr>
                <tr>
                  <td>pLoF</td>
                  ...
                  <td class="pl-2">
                    pLI =
                    <span v-html="roundIt(gene?.gnomad_constraints?.pli)" /><br />
                    o/e =
                    <span v-html="roundIt(gene?.gnomad_constraints?.oe_lof)" />
                    (<span v-html="roundIt(gene?.gnomad_constraints?.oe_lof_lower)" />
                    -
                    <mark
                      class="bg-warning"
                      v-html="roundIt(gene?.gnomad_constraints?.oe_lof_upper, 2, 'LOEUF')"
                    />)
                  </td>
                </tr>
              </tbody>
    ...
    <div class="col mb-2 pl-2 pr-0">
      <div class="card h-100">
        <div class="card-header pl-2 pt-1 pb-1 pr-2">
          <span class="font-weight-bolder" style="font-size: 120%"> NCBI Summary </span>
        </div>
        <div class="card-body pb-2 pt-2">
    ...
    <div class="col mb-2 pl-2 pr-0">
      <div class="card h-100">
        <div class="card-header pl-2 pt-1 pb-1 pr-2">
          <span class="font-weight-bolder" style="font-size: 120%"> Alternate Identifiers </span>
        </div>
        <div class="card-body pb-2 pt-2">
          <div>
    ...
    <div class="col mb-2 pl-2 pr-0">
      <div class="card h-100">
        <div class="card-header pl-2 pt-1 pb-1 pr-2">
          <span class="font-weight-bolder" style="font-size: 120%"> External Resources </span>
        </div>
        <div class="card-body pb-2 pt-2">
          <div class="row">
            <div class="col-6 p-0">
              <div>
                ...
                <span v-else class="text-muted pt-3"> <i-mdi-launch /> COSMIC</span>
              </div>
              ...
              <div>
                ...
                <span v-else class="text-muted pt-3"> <i-mdi-launch /> OMIM</span>
              </div>
            </div>
            <div class="col-6 p-0">
              <div>
              ...
              <div>
                ...
                <span v-else class="text-muted pt-3"> <i-mdi-launch /> Missense3D </span>
              </div>
              <div>
                <a :href="`https://varsome.com/gene/hg19/${gene?.hgnc?.hgnc_id}`" target="_blank">
                  <i-mdi-launch />
                  VarSome
                </a>
              </div>
    ...
    <div class="col mb-2 pl-2 pr-0">
      <div class="card h-100">
        <div class="card-header pl-2 pt-1 pb-1 pr-2">
          <span class="font-weight-bolder" style="font-size: 120%"> Disease Annotation </span>
        </div>
        <div class="card-body pb-2 pt-2">
          ...
          <div v-else class="text-muted">No Orphanet disorders annotated in dbNSFP.</div>

          <div v-if="gene.dbnsfp?.mim_disease?.length" class="mb-2">
            <strong>OMIM Diseases:</strong>
            {{ gene.dbnsfp.mim_disease.join(', ') }}
          </div>
          <div v-else class="text-muted">No OMIM diseases annotated in dbNSFP.</div>
        </div>
      </div>
    </div>
    ...
    <div class="col mb-2 pl-2 pr-0">
      <div class="card h-100">
        ...
        <div class="card-body pb-2 pt-2" v-if="gene?.acmg_sf">
          ...
          <div><strong>inheritance:</strong> {{ gene.acmg_sf.inheritance }}</div>
          <div>
        ...
        <div v-else class="text-muted text-center font-italic">Gene is not on ACMG SF list.</div>
      </div>
    </div>
    ...
    <div class="col mb-2 pl-2 pr-0">
      <div class="card h-100">
        <div class="card-header pl-2 pt-1 pb-1 pr-2">
          <span class="font-weight-bolder" style="font-size: 120%"> GeneRIFs </span>
        </div>
        <div class="card-body pb-2 pt-2">
          <ul
    ...
    <div class="col mb-2 pl-2 pr-0">
      <div class="card h-100">
        <div class="card-header pl-2 pt-1 pb-1 pr-2">
          <span class="font-weight-bolder" style="font-size: 120%"> Locus-Specific Databases </span>
        </div>
