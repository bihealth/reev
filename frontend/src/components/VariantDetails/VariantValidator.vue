      ...
      <div class="tab-content">
        <template v-for="(data, identifier, index) in variantValidatorResults" :key="index">
          ...
          >
            ...
            >
              <ul>
                <li v-for="(warning, indexW) in data.validation_warnings" :key="indexW">
                  {{ warning }}
                </li>
              </ul>
            </div>
              ...
              <div class="col-6 pl-0">
                <div class="card">
                  ...
                  <table class="card-body table table-hover table-striped">
                    ...
                    <tbody>
                      <tr
                        v-if="data.hgvs_transcript_variant && data.hgvs_transcript_variant.length"
                      >
                        <td>Transcript <span class="badge badge-dark">:c.</span></td>
                        <td>{{ data.hgvs_transcript_variant }}</td>
                      </tr>
                      <tr
                        v-if="data.hgvs_refseqgene_variant && data.hgvs_refseqgene_variant.length"
                      >
