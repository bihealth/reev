...
export interface Props {
  ...
  benignVeryStrongUpper?: number | null
  benignStrongUpper?: number | null
  benignModerateUpper?: number | null
  benignSupportingUpper?: number | null
  pathogenicSupportingLower?: number | null
  pathogenicModerateLower?: number | null
  pathogenicStrongLower?: number | null
  pathogenicVeryStrongLower?: number | null
}
...
const xuBenignVeryStrongUpper = computed(() => {
  if (props.benignVeryStrongUpper === null) {
    ...
    return (
      (props.width / (props.rangeUpper - props.rangeLower)) * (0 - props.rangeLower) +
      (props.width / (props.rangeUpper - props.rangeLower)) * props.benignVeryStrongUpper
    )
  }
})
...
const xuBenignStrongUpper = computed(() => {
  if (props.benignStrongUpper === null) {
    ...
    return (
      (props.width / (props.rangeUpper - props.rangeLower)) * (0 - props.rangeLower) +
      (props.width / (props.rangeUpper - props.rangeLower)) * props.benignStrongUpper
    )
  }
})
...
const xuBenignModerateUpper = computed(() => {
  if (props.benignModerateUpper === null) {
    ...
    return (
      (props.width / (props.rangeUpper - props.rangeLower)) * (0 - props.rangeLower) +
      (props.width / (props.rangeUpper - props.rangeLower)) * props.benignModerateUpper
    )
  }
})
...
const xuBenignSupportingUpper = computed(() => {
  if (props.benignSupportingUpper === null) {
    ...
    return (
      (props.width / (props.rangeUpper - props.rangeLower)) * (0 - props.rangeLower) +
      (props.width / (props.rangeUpper - props.rangeLower)) * props.benignSupportingUpper
    )
  }
})
...
const xuPathoSupportingLower = computed(() => {
  if (props.pathogenicSupportingLower === null) {
    ...
    return (
      (props.width / (props.rangeUpper - props.rangeLower)) * (0 - props.rangeLower) +
      (props.width / (props.rangeUpper - props.rangeLower)) * props.pathogenicSupportingLower
    )
  }
})
...
const xuPathoModerateLower = computed(() => {
  if (props.pathogenicModerateLower === null) {
    ...
    return (
      (props.width / (props.rangeUpper - props.rangeLower)) * (0 - props.rangeLower) +
      (props.width / (props.rangeUpper - props.rangeLower)) * props.pathogenicModerateLower
    )
  }
})
...
const xuPathoStrongLower = computed(() => {
  if (props.pathogenicStrongLower === null) {
    ...
    return (
      (props.width / (props.rangeUpper - props.rangeLower)) * (0 - props.rangeLower) +
      (props.width / (props.rangeUpper - props.rangeLower)) * props.pathogenicStrongLower
    )
  }
})
...
const xuPathoVeryStrongLower = computed(() => {
  if (props.pathogenicVeryStrongLower === null) {
    ...
    return (
      (props.width / (props.rangeUpper - props.rangeLower)) * (0 - props.rangeLower) +
      (props.width / (props.rangeUpper - props.rangeLower)) * props.pathogenicVeryStrongLower
    )
  }
})
...
const circleFill = computed((): string => {
  ...
  } else if (props.benignModerateUpper !== null && props.value < props.benignModerateUpper) {
    return getColorByName('benignModerate')
  } else if (props.benignSupportingUpper !== null && props.value < props.benignSupportingUpper) {
  ...
  } else if (props.pathogenicStrongLower !== null && props.value > props.pathogenicStrongLower) {
...
<template>
  ...
  >
    <rect
      v-if="xlBenignVeryStrongLower !== null && xuBenignVeryStrongUpper !== null"
    ...
    <circle
      :cx="
        props.marginX +
        (props.width * (0 - props.rangeLower)) / (props.rangeUpper - props.rangeLower) +
